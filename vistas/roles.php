...
if(isset($_SESSION['usuario'])){
			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">Actualiza Roles</h4>
					</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('#tablaCategoriaLoad').load("roles/tablaRoles.php");
			...
			$('#btnAgregaCategoria').click(function(){
				...
				$.ajax({
					type:"POST",
					data:datos,
					url:"../procesos/roles/agregaRol.php",
					success:function(r){
						if(r!=1){
					...
					$('#tablaCategoriaLoad').load("roles/tablaRoles.php");
					alertify.success("Rol agregado con exito :D");
				}else{
		...
		$(document).ready(function(){
			$('#btnActualizaCategoria').click(function(){
				...
				$.ajax({
					type:"POST",
					data:datos,
					url:"../procesos/roles/actualizaRol.php",
					success:function(r){
						if(r!=1){
							$('#tablaCategoriaLoad').load("roles/tablaRoles.php");
	...
	<script type="text/javascript">
		...
		function eliminaCategoria(idcategoria){
			alertify.confirm('¿Desea eliminar éste Rol?', function(){ 
				$.ajax({
					type:"POST",
